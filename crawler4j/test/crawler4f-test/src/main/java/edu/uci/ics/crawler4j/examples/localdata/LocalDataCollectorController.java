 ...
 * See the License for the specialc language governing permissions and
...
//	numberOfCrawlers = Integer.parseInt(args[1]);
  ...
  //  config.setPolitenessDelay(1000);
    ...
    for (Object localData : crawlersLocalData) {
      ...
      for(Map.Entry<String,Integer> entry:stat.getTypeCount())
      {
    	  logger.info("Content Type Stat type:{},total count:{}",entry.getKey(),entry.getValue());
      }
    }
